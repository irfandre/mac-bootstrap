...
sudo scutil --set ComputerName "exopl"
sudo scutil --set HostName "exopl"
sudo scutil --set LocalHostName "exopl"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "exopl"
